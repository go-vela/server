...
func TestNative_environment(t *testing.T) {
	...
	tests := []struct {
		...
		// push
		{
			...
			r:     &api.Repo{ID: &num64, Owner: &api.User{ID: &num64, Name: &str, Token: &str, Active: &booL, Admin: &booL}, Org: &str, Name: &str, FullName: &str, Link: &str, Clone: &str, Branch: &str, Topics: &topics, BuildLimit: &num16, Timeout: &num16, Visibility: &str, Private: &booL, Trusted: &booL, Active: &booL},
...
func Test_client_EnvironmentBuild(t *testing.T) {
	...
	tests := []struct {
		...
		{"push", fields{
			...
			repo:     &api.Repo{ID: &num64, Owner: &api.User{ID: &num64, Name: &str, Token: &str, Active: &booL, Admin: &booL}, Org: &str, Name: &str, FullName: &str, Link: &str, Clone: &str, Branch: &str, Topics: &topics, BuildLimit: &num16, Timeout: &num16, Visibility: &str, Private: &booL, Trusted: &booL, Active: &booL},
