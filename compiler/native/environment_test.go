	...
	want := yaml.StepSlice{
		&yaml.Step{
			...
			Environment: raw.StringSliceMap{
				...
				"REPOSITORY_ALLOW_PULL_FORK": "false",
				...
				"VELA_REPO_ALLOW_PULL_FORK":  "false",
