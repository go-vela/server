	...
	want := &pipeline.Build{
		...
		Steps: pipeline.ContainerSlice{
			...
			&pipeline.Container{
				ID:          "",
				Directory:   "",
				Commands:    []string{"echo inline_templatename"},
				Environment: helloEnv,
...
func TestNative_Compile_StageNameCollisionPurged(t *testing.T) {
	...
	initEnv := environment(build, m, nil, nil)

	stepEnv := environment(build, m, nil, nil)
...
func TestNative_Compile_StepNameCollisionPurged(t *testing.T) {
	...
	buildEnv := environment(build, m, nil, nil)

	testEnv := environment(build, m, nil, nil)
...
func generateTestEnv(m *internal.Metadata, pipelineType string) map[string]string {
				...
				Stages: []*pipeline.Stage{
					...
					},
					{
						...
						Steps: []*pipeline.Container{
							{
								ID:          "",
								Commands:    []string{"echo from inline"},
								Directory:   "",
								Environment: generateTestEnv(m, ""),
								Image:       "alpine",
								Name:        "test",
								Pull:        "not_present",
								Number:      3,
					...
					},
					{
						...
						Steps: []*pipeline.Container{
							{
								ID:          "",
								Commands:    []string{"echo hello from foo"},
								Directory:   "",
								Environment: generateTestEnv(m, ""),
								Image:       "alpine",
					...
					},
					{
						...
						Steps: []*pipeline.Container{
							{
								ID:          "",
								Commands:    []string{"echo hello from bar"},
								Directory:   "",
								Environment: generateTestEnv(m, ""),
								Image:       "alpine",
		...
		},
		{
			...
			want: &pipeline.Build{
				...
				Steps: []*pipeline.Container{
					...
					{
						ID:          "",
						Commands:    []string{"echo hello from star"},
						Directory:   "",
						Environment: generateTestEnv(m, ""),
						Name:        "golang_star",
						Image:       "alpine",
				...
				Stages: []*pipeline.Stage{
					...
					},
					{
						...
						Steps: []*pipeline.Container{
							{
								ID:          "",
								Commands:    []string{"echo from inline foo"},
								Directory:   "",
								Environment: generateTestEnv(m, constants.PipelineTypeGo),
								Image:       "alpine",
								Name:        "foo",
								Pull:        "not_present",
								Number:      3,
					...
					},
					{
						...
						Steps: []*pipeline.Container{
							{
								ID:          "",
								Commands:    []string{"echo from inline bar"},
								Directory:   "",
								Environment: generateTestEnv(m, constants.PipelineTypeGo),
								Image:       "alpine",
								Name:        "bar",
					...
					},
					{
						...
						Steps: []*pipeline.Container{
							{
								ID:          "",
								Commands:    []string{"echo from inline star"},
								Directory:   "",
								Environment: generateTestEnv(m, constants.PipelineTypeGo),
								Image:       "alpine",
								Name:        "star",
