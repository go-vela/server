...
type (
	...
	Step struct {
		...
		Artifact    Artifact               `yaml:"artifact,omitempty" json:"artifact,omitempty" jsonschema:"description=Artifact configuration for the step.\nReference: https://go-vela.github.io/docs/reference/yaml/steps/#the-artifact-key"`
...
func (s *StepSlice) ToPipeline() *pipeline.ContainerSlice {
	...
	for _, step := range *s {
		...
		*stepSlice = append(*stepSlice, &pipeline.Container{
			...
			Artifact:    *step.Artifact.ToPipeline(),
