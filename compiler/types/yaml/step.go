...
type (
	...
	Step struct {
		...
		Template    StepTemplate       `yaml:"template,omitempty"    json:"template"              jsonschema:"oneof_required=template,description=Name of template to expand in the pipeline.\nReference: https://go-vela.github.io/docs/reference/yaml/steps/#the-template-key"`
		Artifacts   Artifacts          `yaml:"artifacts,omitempty"   json:"artifacts"             jsonschema:"description=Artifacts configuration for the step. Set secured: false to allow unauthenticated downloads.\nReference: https://go-vela.github.io/docs/reference/yaml/steps/#the-artifacts-key"`
		...
		Parameters  map[string]any     `yaml:"parameters,omitempty"  json:"parameters,omitempty"  jsonschema:"description=Extra configuration variables for a plugin.\nReference: https://go-vela.github.io/docs/reference/yaml/steps/#the-parameters-key"`
		...
		Git         Git                `yaml:"git,omitempty"         json:"git"                   jsonschema:"description=Git configuration for the step.\nReference: https://go-vela.github.io/docs/reference/yaml/steps/#the-git-key"`
	}
)
...
func (s *StepSlice) UnmarshalYAML(unmarshal func(any) error) error {
