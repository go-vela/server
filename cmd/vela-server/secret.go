...
func setupVault(c *cli.Context) (secret.Service, error) {
	...
	return vault.New(c.String("vault-addr"), c.String("vault-token"), c.String("vault-version"), c.String("vault-prefix"), c.String("vault-auth-method"), c.String("vault-aws-role"), c.Duration("vault-renewal"))
}
