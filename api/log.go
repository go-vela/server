...
// SaveInitStepLog is a helper function for APIs to create or update
// an InitStep and Log.
func SaveInitStepLog(c *gin.Context, b *library.Build, i *library.InitStep, l *library.Log) (*library.InitStep, *library.Log, error) {
	if len(l.GetData()) == 0 {
		return i, l, nil
	}
