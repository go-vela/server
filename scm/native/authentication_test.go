...
func TestNative_Authenticate(t *testing.T) {
	// setup context
...
func TestNative_Authenticate_NoCode(t *testing.T) {
	// setup context
	gin.SetMode(gin.TestMode)
...
func TestNative_Authenticate_NoState(t *testing.T) {
	// setup context
	gin.SetMode(gin.TestMode)
...
func TestNative_Authenticate_BadToken(t *testing.T) {
	// setup context
	gin.SetMode(gin.TestMode)
...
func TestNative_AuthenticateToken(t *testing.T) {
	// setup context
	gin.SetMode(gin.TestMode)
...
func TestNative_LoginWCreds(t *testing.T) {
	// setup context
	gin.SetMode(gin.TestMode)
