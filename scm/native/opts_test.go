...
func TestNative_ClientOpt_WithAddress(t *testing.T) {
	// setup tests
	tests := []struct {
		address string
		want    config
...
func TestNative_ClientOpt_WithClientID(t *testing.T) {
	// setup tests
	tests := []struct {
		failure bool
		id      string
...
func TestNative_ClientOpt_WithClientSecret(t *testing.T) {
	// setup tests
	tests := []struct {
		failure bool
		secret  string
...
func TestNative_ClientOpt_WithKind(t *testing.T) {
	// setup tests
	tests := []struct {
		failure bool
		kind    string
	...
	for _, test := range tests {
		...
		if test.failure {
			if err == nil {
				t.Errorf("WithKind should have returned err")
			}
		...
		if err != nil {
			t.Errorf("WithKind returned err: %v", err)
		}

		if !reflect.DeepEqual(_service.config.Kind, test.want) {
			t.Errorf("WithKind is %v, want %v", _service.config.Kind, test.want)
		}
	}
}

func TestNative_ClientOpt_WithServerAddress(t *testing.T) {
	// setup tests
	tests := []struct {
		failure bool
		address string
...
func TestNative_ClientOpt_WithServerWebhookAddress(t *testing.T) {
	// setup tests
	tests := []struct {
		failure        bool
		address        string
...
func TestNative_ClientOpt_WithStatusContext(t *testing.T) {
	// setup tests
	tests := []struct {
		failure bool
		context string
...
func TestNative_ClientOpt_WithWebUIAddress(t *testing.T) {
	// setup tests
	tests := []struct {
		address string
		want    string
...
func TestNative_ClientOpt_WithScopes(t *testing.T) {
	// setup tests
	tests := []struct {
		failure bool
		scopes  []string
