...
func (c *Client) createOrg(org, path string, data map[string]any) (*api.Secret, error) {
...
func (c *Client) createRepo(org, repo, path string, data map[string]any) (*api.Secret, error) {
...
func (c *Client) createShared(org, team, path string, data map[string]any) (*api.Secret, error) {
...
func (c *Client) create(path string, data map[string]any) (*api.Secret, error) {
