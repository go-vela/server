...
func TestSettings_EngineOpt_WithClient(t *testing.T) {
	// setup types
...
func TestSettings_EngineOpt_WithLogger(t *testing.T) {
	// setup types
...
func TestSettings_EngineOpt_WithSkipCreation(t *testing.T) {
	// setup types
...
func TestSettings_EngineOpt_WithContext(t *testing.T) {
	// setup types
	e := &engine{config: new(config)}
