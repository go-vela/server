...
func TestInstallation_New(t *testing.T) {
	// setup types
...
func testPostgres(t *testing.T) (*Engine, sqlmock.Sqlmock) {
	...
	if err != nil {
		t.Errorf("unable to create new postgres installation engine: %v", err)
	}
...
func testSqlite(t *testing.T) *Engine {
	...
	if err != nil {
		t.Errorf("unable to create new sqlite installation engine: %v", err)
	}
