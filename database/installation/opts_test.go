...
func TestInstallation_EngineOpt_WithClient(t *testing.T) {
	// setup types
...
func TestInstallation_EngineOpt_WithLogger(t *testing.T) {
	// setup types
...
func TestInstallation_EngineOpt_WithSkipCreation(t *testing.T) {
	// setup types
...
func TestInstallation_EngineOpt_WithContext(t *testing.T) {
	// setup types
	e := &Engine{config: new(config)}
