...
func TestRepo_Engine_GetRepoForName(t *testing.T) {
	...
	_rows := sqlmock.NewRows(
		[]string{"id", "user_id", "hash", "org", "name", "full_name", "link", "clone", "branch", "build_limit", "timeout", "counter", "visibility", "private", "trusted", "active", "allow_pull", "allow_push", "allow_deploy", "allow_tag", "allow_release", "allow_comment", "pipeline_type", "previous_name"}).
