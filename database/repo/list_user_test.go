...
func TestRepo_Engine_ListReposForUser(t *testing.T) {
	...
	_rows = sqlmock.NewRows(
		[]string{"id", "user_id", "hash", "org", "name", "full_name", "link", "clone", "branch", "timeout", "counter", "visibility", "private", "trusted", "active", "allow_pull", "allow_push", "allow_deploy", "allow_tag", "allow_release", "allow_comment", "pipeline_type", "previous_name"}).
