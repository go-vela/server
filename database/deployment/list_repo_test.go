...
func TestDeployment_Engine_ListDeploymentsForRepo(t *testing.T) {
	...
	_rows = sqlmock.NewRows(
		...
		AddRow(2, 2, 2, "https://github.com/github/octocat/deployments/1", "octocat", "48afb5bdc41ad69bf22588491333f7cf71135163", "refs/heads/master", "vela-deploy", "production", "Deployment request from Vela", "{\"foo\":\"test1\"}", "{}")
