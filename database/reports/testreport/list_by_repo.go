...
// ListTestReportsByRepo returns a list of test reports by repo ID from the database.
func (e *Engine) ListTestReportsByRepo(ctx context.Context, r *api.Repo, page, perPage int) ([]*api.TestReport, error) {
