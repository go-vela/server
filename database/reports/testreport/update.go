...
// UpdateTestReport updates an existing test report in the database.
func (e *Engine) UpdateTestReport(ctx context.Context, t *api.TestReport) (*api.TestReport, error) {
