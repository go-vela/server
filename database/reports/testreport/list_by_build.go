...
// ListTestReportsByBuild returns a list of test reports by build ID from the database.
func (e *Engine) ListTestReportsByBuild(ctx context.Context, b *api.Build, page, perPage int) ([]*api.TestReport, error) {
