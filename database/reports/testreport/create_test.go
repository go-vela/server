...
func TestTestReport_Engine_CreateTestReport(t *testing.T) {
	...
	_mock.ExpectQuery(`INSERT INTO "testreports" ("build_id","created_at","id")
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			got, err := test.database.CreateTestReport(context.TODO(), _testReport)
