...
// CreateTestAttachmentTable creates the testattachments table in the database.
func (e *Engine) CreateTestAttachmentTable(ctx context.Context, driver string) error {
