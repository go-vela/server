...
func (e *Engine) CountSecretsForTeam(ctx context.Context, org, team string, filters map[string]any) (int64, error) {
...
func (e *Engine) CountSecretsForTeams(ctx context.Context, org string, teams []string, filters map[string]any) (int64, error) {
