...
func TestDatabase_Client_GetRepoBuildList(t *testing.T) { //[here] 0
	// setup types
	r := testRepo()
	r.SetID(1)
	r.SetOrg("foo")
...
func TestDatabase_Client_GetRepoBuildList_No_Result(t *testing.T) { //[here] 1
	// setup types
	r := testRepo()
	r.SetID(2)
	r.SetOrg("foo")
...
func TestDatabase_Client_GetRepoBuildListByEvent(t *testing.T) { //[here] 2
	// setup types
	r := testRepo()
	r.SetID(1)
	r.SetOrg("foo")
...
func TestDatabase_Client_GetRepoBuildListByEvent_No_Results(t *testing.T) { //[here] 3
	// setup types
	r := testRepo()
	r.SetID(1)
	r.SetOrg("foo")
...
func TestDatabase_Client_GetRepoBuildCount(t *testing.T) { //[here] 4
	// setup types
	r := testRepo()
	r.SetID(1)
	r.SetOrg("foo")
...
func TestDatabase_Client_GetRepoBuildCountByEvent(t *testing.T) { //[here] 5
	// setup types
	r := testRepo()
	r.SetID(1)
	r.SetOrg("foo")
...
//////////////////////////[here] Tests below this line fail.

func TestDatabase_Client_GetOrgBuildList(t *testing.T) { //[here] .0
	// setup types
	r := testRepo()
	r.SetID(1)
	r.SetOrg("foo")
...
func TestDatabase_Client_GetOrgBuildList_No_Result(t *testing.T) { //[here] .1
	// setup types
	r := testRepo()
	r.SetID(2)
	r.SetOrg("foo")
...
func TestDatabase_Client_GetOrgBuildListByEvent(t *testing.T) { //[here] .2
	// setup types
	r := testRepo()
	r.SetID(1)
	r.SetOrg("foo")
...
func TestDatabase_Client_GetOrgBuildListByEvent_No_Results(t *testing.T) { //[here] .3
	// setup types
	r := testRepo()
	r.SetID(1)
	r.SetOrg("foo")
...
func TestDatabase_Client_GetOrgBuildCount(t *testing.T) { //[here] .4
	// setup types
	r := testRepo()
	r.SetID(1)
	r.SetOrg("foo")
...
func TestDatabase_Client_GetOrgBuildCountByEvent(t *testing.T) { //[here] .5
	// setup types
	r := testRepo()
	r.SetID(1)
	r.SetOrg("foo")
