...
func TestFavorite_New(t *testing.T) {
	// setup types
	...
	_mock.ExpectExec(CreateRepoIndex).WillReturnResult(sqlmock.NewResult(1, 1))
	_mock.ExpectExec(CreateUserRepoIndex).WillReturnResult(sqlmock.NewResult(1, 1))
